...
- ```slingshot --suggest [keyword prefix]```: calls the search function -> if prefix exists, prints a list of suggested keywords on each new line
- ```slingshot --display```: prints a list of objects, in form of "[reference #]: {[key]:[value]...}" on each new line
